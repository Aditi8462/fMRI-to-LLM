...
Part 3 Additions: 
    - Used Joblib to save the model instead of retraining
    - Saved test data for analysis and visualization parts
...
def build_model(SUBJECT="sub-01", TASK="Classificationprobewithoutfeedback"):
    ...
    ##Part 3 addition: Save trained model using joblib
    ...
    ##Part 3 addition: Save test data:
    # Save test data
